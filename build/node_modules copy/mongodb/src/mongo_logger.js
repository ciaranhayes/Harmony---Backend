    ...
    switch (logObject.name) {
        ...
        case constants_1.CONNECTION_POOL_CREATED:
            ...
            if (logObject.options) {
                ...
                log = Object.assign(Object.assign({}, log), { maxIdleTimeMS,
                    minPoolSize,
                    maxPoolSize,
                    maxConnecting,
                    waitQueueTimeoutMS });
...
class MongoLogger {
    ...
    log(severity, component, message) {
        ...
        if (typeof message === 'string') {
            ...
            if (isLogConvertible(message)) {
                logMessage = Object.assign(Object.assign({}, logMessage), message.toLog());
            }
            else {
                logMessage = Object.assign(Object.assign({}, logMessage), defaultLogTransform(message, this.maxDocumentLength));
            }
        }
    ...
    static resolveOptions(envOptions, clientOptions) {
        ...
        const combinedOptions = Object.assign(Object.assign(Object.assign({}, envOptions), clientOptions), { mongodbLogPath: resolvedLogPath.mongodbLogPath, mongodbLogPathIsStdErr: resolvedLogPath.mongodbLogPathIsStdErr });
        const defaultSeverity = resolveSeverityConfiguration((_a = combinedOptions.mongodbLogComponentSeverities) === null || _a === void 0 ? void 0 : _a.default, combinedOptions.MONGODB_LOG_ALL, exports.SeverityLevel.OFF);
        return {
            componentSeverities: {
            ...
            maxDocumentLength: (_h = (_g = combinedOptions.mongodbLogMaxDocumentLength) !== null && _g !== void 0 ? _g : (0, utils_1.parseUnsignedInteger)(combinedOptions.MONGODB_LOG_MAX_DOCUMENT_LENGTH)) !== null && _h !== void 0 ? _h : 1000,

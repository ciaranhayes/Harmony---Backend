...
class AutoEncrypter {
    ...
    constructor(client, options) {
        ...
        if (((_b = options.credentialProviders) === null || _b === void 0 ? void 0 : _b.aws) && !(0, providers_1.isEmptyCredentials)('aws', this._kmsProviders)) {
        ...
        mongoCryptOptions.kmsProviders = !Buffer.isBuffer(this._kmsProviders)
            ...
            : this._kmsProviders;
        if ((_c = options.options) === null || _c === void 0 ? void 0 : _c.logger) {
        ...
        if (!this._bypassMongocryptdAndCryptShared && !this.cryptSharedLibVersionInfo) {
            ...
            if (net.getDefaultAutoSelectFamily) {
                ...
                Object.assign(clientOptions, (0, client_encryption_1.autoSelectSocketOptions)((_e = (_d = this._client.s) === null || _d === void 0 ? void 0 : _d.options) !== null && _e !== void 0 ? _e : {}));
            }
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this._mongocryptdManager.bypassSpawn) {
                yield this._mongocryptdManager.spawn();
            }
            try {
                const client = yield this._mongocryptdClient.connect();
                return client;
            }
            catch (error) {
    ...
    teardown(force) {
        return __awaiter(this, void 0, void 0, function* () {
            var _b;
            yield ((_b = this._mongocryptdClient) === null || _b === void 0 ? void 0 : _b.close(force));
        });
    }
    /**
     ...
     */
    encrypt(ns_1, cmd_1) {
        return __awaiter(this, arguments, void 0, function* (ns, cmd, options = {}) {
            var _b;
            ...
            return (0, bson_1.deserialize)(yield stateMachine.execute(this, context, options), {
                promoteValues: false,
                promoteLongs: false
            });
        });
    ...
    decrypt(response_1) {
        return __awaiter(this, arguments, void 0, function* (response, options = {}) {
            ...
            context.id = this._contextCounter++;
            const stateMachine = new state_machine_1.StateMachine(Object.assign(Object.assign({}, options), { proxyOptions: this._proxyOptions, tlsOptions: this._tlsOptions, socketOptions: (0, client_encryption_1.autoSelectSocketOptions)(this._client.s.options) }));
            return yield stateMachine.execute(this, context, options);
        });
    }
    /**
    ...
    askForKMSCredentials() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, providers_1.refreshKMSCredentials)(this._kmsProviders, this._credentialProviders);
        });
    }
    /**

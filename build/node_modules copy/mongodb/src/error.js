...
class MongoNetworkError extends MongoError {
    ...
    constructor(message, options) {
        ...
        this.beforeHandshake = !!(options === null || options === void 0 ? void 0 : options.beforeHandshake);
    }
    get name() {
...
class MongoWriteConcernError extends MongoServerError {
     ...
     **/
    constructor(result) {
        super(Object.assign(Object.assign({}, result.writeConcernError), result));
...
function needsRetryableWriteLabel(error, maxWireVersion, serverType) {
    ...
    if (error instanceof MongoWriteConcernError) {
        ...
        const code = (_b = error.result.writeConcernError.code) !== null && _b !== void 0 ? _b : Number(error.code);

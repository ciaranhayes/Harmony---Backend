...
class MongoClient extends mongo_types_1.TypedEventEmitter {
    ...
    get serverApi() {
        return this.options.serverApi && Object.freeze(Object.assign({}, this.options.serverApi));
    }
    /**
    ...
    bulkWrite(models, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield new executor_1.ClientBulkWriteExecutor(this, models, (0, utils_1.resolveOptions)(this, options)).execute();
        });
    }
    /**
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.connectionLock) {
                return yield this.connectionLock;
            }
            try {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.tls) {
                if (typeof options.tlsCAFile === 'string') {
                    (_a = options.ca) !== null && _a !== void 0 ? _a : (options.ca = yield fs_1.promises.readFile(options.tlsCAFile));
                }
                if (typeof options.tlsCRLFile === 'string') {
                    (_b = options.crl) !== null && _b !== void 0 ? _b : (options.crl = yield fs_1.promises.readFile(options.tlsCRLFile));
                }
                if (typeof options.tlsCertificateKeyFile === 'string') {
                    if (!options.key || !options.cert) {
                        const contents = yield fs_1.promises.readFile(options.tlsCertificateKeyFile);
                        (_c = options.key) !== null && _c !== void 0 ? _c : (options.key = contents);
                        (_d = options.cert) !== null && _d !== void 0 ? _d : (options.cert = contents);
                    }
                }
            }
            ...
            if (((_e = options.credentials) === null || _e === void 0 ? void 0 : _e.mechanism) === providers_1.AuthMechanism.MONGODB_OIDC) {
                const allowedHosts = ((_g = (_f = options.credentials) === null || _f === void 0 ? void 0 : _f.mechanismProperties) === null || _g === void 0 ? void 0 : _g.ALLOWED_HOSTS) || mongo_credentials_1.DEFAULT_ALLOWED_HOSTS;
                const isServiceAuth = !!((_j = (_h = options.credentials) === null || _h === void 0 ? void 0 : _h.mechanismProperties) === null || _j === void 0 ? void 0 : _j.ENVIRONMENT);
                if (!isServiceAuth) {
            ...
            const topologyConnect = () => __awaiter(this, void 0, void 0, function* () {
                var _a, _b;
                try {
                    yield ((_a = this.topology) === null || _a === void 0 ? void 0 : _a.connect(options));
                }
                catch (error) {
            ...
            if (this.autoEncrypter) {
                yield ((_k = this.autoEncrypter) === null || _k === void 0 ? void 0 : _k.init());
    ...
    close() {
        return __awaiter(this, arguments, void 0, function* (force = false) {
            if (this.closeLock) {
                return yield this.closeLock;
            }
            try {
                this.closeLock = this._close(force);
                yield this.closeLock;
            }
            finally {
                // release
    ...
    _close() {
        return __awaiter(this, arguments, void 0, function* (force = false) {
            ...
            yield Promise.all(activeCursorCloses);
            ...
            if (servers.length !== 0) {
                ...
                if (endSessions.length !== 0) {
                    try {
                        yield (0, execute_operation_1.executeOperation)(this, new run_command_1.RunAdminCommandOperation({ endSessions }, { readPreference: read_preference_1.ReadPreference.primaryPreferred, noResponse: true }));
                    }
                    catch (error) {
            ...
            if (encrypter) {
                yield encrypter.close(this, force);
            }
        });
    }
    /**
    ...
    startSession(options) {
        const session = new sessions_1.ClientSession(this, this.s.sessionPool, Object.assign({ explicit: true }, options), this.options);
    ...
    withSession(optionsOrExecutor, executor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield withSessionCallback(session);
            }
            finally {
                try {

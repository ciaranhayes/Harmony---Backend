...
class Timeout extends Promise {
    ...
    constructor(executor = () => null, options) {
        var _a;
        const duration = (_a = options === null || options === void 0 ? void 0 : options.duration) !== null && _a !== void 0 ? _a : 0;
        const unref = !!(options === null || options === void 0 ? void 0 : options.unref);
...
class TimeoutContext {
    static create(options) {
        var _a, _b;
        if (((_a = options.session) === null || _a === void 0 ? void 0 : _a.timeoutContext) != null)
            return (_b = options.session) === null || _b === void 0 ? void 0 : _b.timeoutContext;
...
class CSOTTimeoutContext extends TimeoutContext {
    ...
    get serverSelectionTimeout() {
        var _a;
        // check for undefined
        if (typeof this._serverSelectionTimeout !== 'object' || ((_a = this._serverSelectionTimeout) === null || _a === void 0 ? void 0 : _a.cleared)) {
    ...
    get connectionCheckoutTimeout() {
        ...
        if (typeof this._connectionCheckoutTimeout !== 'object' ||
            ((_a = this._connectionCheckoutTimeout) === null || _a === void 0 ? void 0 : _a.cleared)) {
    ...
    refresh() {
        ...
        this.start = Math.trunc(performance.now());
        this.minRoundTripTime = 0;
        (_a = this._serverSelectionTimeout) === null || _a === void 0 ? void 0 : _a.clear();
        (_b = this._connectionCheckoutTimeout) === null || _b === void 0 ? void 0 : _b.clear();
    }
    clear() {
        var _a, _b;
        (_a = this._serverSelectionTimeout) === null || _a === void 0 ? void 0 : _a.clear();
    ...
    getRemainingTimeMSOrThrow(message) {
        const { remainingTimeMS } = this;
        if (remainingTimeMS <= 0)
            throw new error_1.MongoOperationTimeoutError(message !== null && message !== void 0 ? message : `Expired after ${this.timeoutMS}ms`);

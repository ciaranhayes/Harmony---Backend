...
class Topology extends mongo_types_1.TypedEventEmitter {
    ...
    constructor(client, seeds, options) {
        ...
        options = options !== null && options !== void 0 ? options : Object.assign({ hosts: [utils_1.HostAddress.fromString('localhost:27017')] }, Object.fromEntries(connection_string_1.DEFAULT_OPTIONS.entries()));
    ...
    connect(options) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            (_a = this.connectionLock) !== null && _a !== void 0 ? _a : (this.connectionLock = this._connect(options));
            try {
                yield this.connectionLock;
                return this;
            }
            finally {
                this.connectionLock = undefined;
    ...
    _connect(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const selectServerOptions = Object.assign(Object.assign({ operationName: 'ping' }, options), { timeoutContext });
            try {
                const server = yield this.selectServer((0, server_selection_1.readPreferenceServerSelector)(readPreference), selectServerOptions);
                const skipPingOnConnect = this.s.options.__skipPingOnConnect === true;
                if (!skipPingOnConnect && this.s.credentials) {
                    yield server.command((0, utils_1.ns)('admin.$cmd'), { ping: 1 }, { timeoutContext });
    ...
    selectServer(selector, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.timeoutContext)
                ...
                timeout = timeout_1.Timeout.expires((_c = options.serverSelectionTimeoutMS) !== null && _c !== void 0 ? _c : 0);
            }
            const isSharded = this.description.type === common_1.TopologyType.Sharded;
            const session = options.session;
            const transaction = session && session.transaction;
            if (isSharded && transaction && transaction.server) {
                if ((_d = this.client.mongoLogger) === null || _d === void 0 ? void 0 : _d.willLog(mongo_logger_1.MongoLoggableComponent.SERVER_SELECTION, mongo_logger_1.SeverityLevel.DEBUG)) {
                    (_e = this.client.mongoLogger) === null || _e === void 0 ? void 0 : _e.debug(mongo_logger_1.MongoLoggableComponent.SERVER_SELECTION, new server_selection_events_1.ServerSelectionSucceededEvent(selector, this.description, transaction.server.pool.address, options.operationName));
                }
                if ((_f = options.timeoutContext) === null || _f === void 0 ? void 0 : _f.clearServerSelectionTimeout)
            ...
            try {
                ...
                const server = yield (timeout ? Promise.race([serverPromise, timeout]) : serverPromise);
                if (((_g = options.timeoutContext) === null || _g === void 0 ? void 0 : _g.csotEnabled()) && server.description.minRoundTripTime !== 0) {
                ...
                if (timeout_1.TimeoutError.is(error)) {
                    // Timeout
                    waitQueueMember.cancelled = true;
                    const timeoutError = new error_1.MongoServerSelectionError(`Server selection timed out after ${timeout === null || timeout === void 0 ? void 0 : timeout.duration} ms`, this.description);
                    if ((_h = this.client.mongoLogger) === null || _h === void 0 ? void 0 : _h.willLog(mongo_logger_1.MongoLoggableComponent.SERVER_SELECTION, mongo_logger_1.SeverityLevel.DEBUG)) {
                        (_j = this.client.mongoLogger) === null || _j === void 0 ? void 0 : _j.debug(mongo_logger_1.MongoLoggableComponent.SERVER_SELECTION, new server_selection_events_1.ServerSelectionFailedEvent(selector, this.description, timeoutError, options.operationName));
                    }
                    if ((_k = options.timeoutContext) === null || _k === void 0 ? void 0 : _k.csotEnabled()) {
                ...
                if ((_l = options.timeoutContext) === null || _l === void 0 ? void 0 : _l.clearServerSelectionTimeout)
                    timeout === null || timeout === void 0 ? void 0 : timeout.clear();
            }
        });
    }

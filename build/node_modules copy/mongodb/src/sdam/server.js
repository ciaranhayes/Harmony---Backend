...
class Server extends mongo_types_1.TypedEventEmitter {
    ...
    constructor(topology, description, options) {
        ...
        const poolOptions = Object.assign({ hostAddress: description.hostAddress }, options);
        ...
        this.monitor.on(Server.SERVER_HEARTBEAT_SUCCEEDED, (event) => {
            ...
            this.emit(Server.DESCRIPTION_RECEIVED, new server_description_1.ServerDescription(this.description.hostAddress, event.reply, {
                roundTripTime: (_a = this.monitor) === null || _a === void 0 ? void 0 : _a.roundTripTime,
                minRoundTripTime: (_b = this.monitor) === null || _b === void 0 ? void 0 : _b.minRoundTripTime
            }));
    ...
    command(ns, cmd, _a, responseType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (conn == null) {
                try {
                    conn = yield this.pool.checkOut(options);
            ...
            try {
                try {
                    const res = yield conn.command(ns, cmd, options, responseType);
                ...
                if (operationError instanceof error_1.MongoError &&
                    ...
                    yield (0, utils_1.abortable)(reauthPromise, options);

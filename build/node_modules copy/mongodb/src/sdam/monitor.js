...
class Monitor extends mongo_types_1.TypedEventEmitter {
    constructor(server, options) {
        ...
        this.mongoLogger = (_d = this.server.topology.client) === null || _d === void 0 ? void 0 : _d.mongoLogger;
        this.rttSampler = new RTTSampler(10);
        const cancellationToken = this.cancellationToken;
        // TODO: refactor this to pull it directly from the pool, requires new ConnectionPool integration
        const connectOptions = Object.assign(Object.assign({ id: '<monitor>', generation: server.pool.generation, cancellationToken, hostAddress: server.description.hostAddress }, options), { 
    ...
    requestCheck() {
        ...
        (_a = this.monitorId) === null || _a === void 0 ? void 0 : _a.wake();
    }
    reset() {
...
function resetMonitorState(monitor) {
    var _a, _b, _c;
    (_a = monitor.monitorId) === null || _a === void 0 ? void 0 : _a.stop();
...
function checkServer(monitor, callback) {
    ...
    function onHeartbeatSucceeded(hello) {
        ...
        const duration = isAwaitable && monitor.rttPinger
            ? ((_a = monitor.rttPinger.latestRtt) !== null && _a !== void 0 ? _a : (0, utils_1.calculateDurationInMs)(start))
    ...
    if (connection && !connection.closed) {
        ...
        const cmd = Object.assign({ [(serverApi === null || serverApi === void 0 ? void 0 : serverApi.version) || helloOk ? 'hello' : constants_1.LEGACY_HELLO_COMMAND]: 1 }, (isAwaitable && topologyVersion
    ...
    (() => __awaiter(this, void 0, void 0, function* () {
        const socket = yield (0, connect_1.makeSocket)(monitor.connectOptions);
        const connection = (0, connect_1.makeConnection)(monitor.connectOptions, socket);
        // The start time is after socket creation but before the handshake
        start = (0, utils_1.now)();
        try {
            yield (0, connect_1.performInitialHandshake)(connection, monitor.connectOptions);
            return connection;
        }
        catch (error) {
            connection.destroy();
        ...
        monitor.emitAndLogHeartbeat(server_1.Server.SERVER_HEARTBEAT_SUCCEEDED, monitor.server.topology.s.id, (_a = connection.hello) === null || _a === void 0 ? void 0 : _a.connectionId, new events_1.ServerHeartbeatSucceededEvent(monitor.address, duration, connection.hello, useStreamingProtocol(monitor, (_b = connection.hello) === null || _b === void 0 ? void 0 : _b.topologyVersion)));
        ...
        checkServer(monitor, (err, hello) => {
            ...
            if (useStreamingProtocol(monitor, hello === null || hello === void 0 ? void 0 : hello.topologyVersion)) {
                (0, timers_1.setTimeout)(() => {
                    var _a;
                    if (!isInCloseState(monitor)) {
                        (_a = monitor.monitorId) === null || _a === void 0 ? void 0 : _a.wake();
                    }
                }, 0);
            }
            done();

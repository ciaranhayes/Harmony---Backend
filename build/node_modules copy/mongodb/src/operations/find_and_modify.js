...
class FindAndModifyOperation extends command_1.CommandOperation {
    constructor(collection, query, options) {
        ...
        (_a = options.includeResultMetadata) !== null && _a !== void 0 ? _a : (options.includeResultMetadata = false);
    ...
    execute(server, session, timeoutContext) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return options.includeResultMetadata ? result : ((_b = result.value) !== null && _b !== void 0 ? _b : null);
        });
    }
}

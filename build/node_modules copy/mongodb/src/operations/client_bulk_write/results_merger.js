...
class ClientBulkWriteResultsMerger {
    ...
    merge(cursor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                try {
                    for (_a = true, cursor_1 = __asyncValues(cursor); cursor_1_1 = yield cursor_1.next(), _b = cursor_1_1.done, !_b; _a = true) {
                        _d = cursor_1_1.value;
                        _a = false;
                        const document = _d;
                    ...
                    try {
                        if (!_a && !_b && (_c = cursor_1.return)) yield _c.call(cursor_1);
                    }

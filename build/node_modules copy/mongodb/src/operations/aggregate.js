...
class AggregateOperation extends command_1.CommandOperation {
    ...
    execute(server, session, timeoutContext) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield _super.executeCommand.call(this, server, session, command, timeoutContext, this.explain ? responses_1.ExplainedCursorResponse : responses_1.CursorResponse);
        });
    }
}

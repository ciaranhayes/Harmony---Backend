 ...
 */
function executeOperation(client, operation, timeoutContext) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const topology = client.topology == null
            ? yield (0, utils_1.abortable)(autoConnect(client), operation.options)
            : client.topology;
        ...
        try {
            return yield tryOperation(operation, {
                topology,
                timeoutContext,
                session,
                readPreference
 ...
 * @param operation - The operation to execute
 * */
function tryOperation(operation_2, _a) {
    return __awaiter(this, arguments, void 0, function* (operation, { topology, timeoutContext, session, readPreference }) {
        var _b, _c;
        let selector;
        ...
        let server = yield topology.selectServer(selector, {
            session,
        ...
        const inTransaction = (_c = session === null || session === void 0 ? void 0 : session.inTransaction()) !== null && _c !== void 0 ? _c : false;
        ...
        for (let tries = 0; tries < maxTries; tries++) {
            if (previousOperationError) {
                ...
                server = yield topology.selectServer(selector, {
                    session,
                    operationName: operation.commandName,
                    previousServer,
                    signal: operation.options.signal
            ...
            try {
                ...
                return yield operation.execute(server, session, timeoutContext);
            }

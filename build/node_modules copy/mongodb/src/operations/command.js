...
class CommandOperation extends operation_1.AbstractOperation {
    ...
    executeCommand(server, session, cmd, timeoutContext, responseType) {
        return __awaiter(this, void 0, void 0, function* () {
            this.server = server;
            const options = Object.assign(Object.assign(Object.assign({}, this.options), this.bsonOptions), { timeoutContext, readPreference: this.readPreference, session });
            ...
            return yield server.command(this.ns, cmd, options, responseType);
        });
    }
}

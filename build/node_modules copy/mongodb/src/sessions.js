...
class ClientSession extends mongo_types_1.TypedEventEmitter {
    ...
    constructor(client, sessionPool, options, clientOptions) {
        ...
        this.timeoutMS = (_a = options.defaultTimeoutMS) !== null && _a !== void 0 ? _a : (_b = client.s.options) === null || _b === void 0 ? void 0 : _b.timeoutMS;
        ...
        this.supports = {
            ...
            causalConsistency: (_c = options.causalConsistency) !== null && _c !== void 0 ? _c : defaultCausalConsistencyValue
        };
    ...
    get loadBalanced() {
        var _a;
        return ((_a = this.client.topology) === null || _a === void 0 ? void 0 : _a.description.type) === common_1.TopologyType.LoadBalanced;
    }
    /** @internal */
    pin(conn) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (this.inTransaction()) {
                    yield this.abortTransaction(Object.assign(Object.assign({}, options), { throwTimeout: true }));
                }
            }
            catch (error) {
                ...
                maybeClearPinnedConnection(this, Object.assign({ force: true }, options));
            }
        });
    }
    /** @internal */
    asyncDispose() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.endSession({ force: true });
        });
    }
    /**
    ...
    advanceClusterTime(clusterTime) {
        ...
        if (!clusterTime.signature ||
            ((_a = clusterTime.signature.hash) === null || _a === void 0 ? void 0 : _a._bsontype) !== 'Binary' ||
            (typeof clusterTime.signature.keyId !== 'bigint' &&
                typeof clusterTime.signature.keyId !== 'number' &&
                ((_b = clusterTime.signature.keyId) === null || _b === void 0 ? void 0 : _b._bsontype) !== 'Long') // apparently we decode the key to number?
        ) {
    ...
    commitTransaction(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const timeoutMS = typeof (options === null || options === void 0 ? void 0 : options.timeoutMS) === 'number'
                ? options.timeoutMS
                : typeof this.timeoutMS === 'number'
                    ? this.timeoutMS
                    : null;
            const wc = (_a = this.transaction.options.writeConcern) !== null && _a !== void 0 ? _a : (_b = this.clientOptions) === null || _b === void 0 ? void 0 : _b.writeConcern;
            if (wc != null) {
                if (timeoutMS == null && this.timeoutContext == null) {
                    write_concern_1.WriteConcern.apply(command, Object.assign({ wtimeoutMS: 10000, w: 'majority' }, wc));
                }
                else {
                    ...
                    if (wcKeys.length > 2 || (!wcKeys.includes('wtimeoutMS') && !wcKeys.includes('wTimeoutMS')))
                        ...
                        write_concern_1.WriteConcern.apply(command, Object.assign(Object.assign({}, wc), { wtimeoutMS: undefined }));
                }
            }
            if (this.transaction.state === transactions_1.TxnState.TRANSACTION_COMMITTED || this.commitAttempted) {
                if (timeoutMS == null && this.timeoutContext == null) {
                    write_concern_1.WriteConcern.apply(command, Object.assign(Object.assign({ wtimeoutMS: 10000 }, wc), { w: 'majority' }));
                }
                else {
                    write_concern_1.WriteConcern.apply(command, Object.assign(Object.assign({ w: 'majority' }, wc), { wtimeoutMS: undefined }));
                }
            }
            ...
            const timeoutContext = (_c = this.timeoutContext) !== null && _c !== void 0 ? _c : (typeof timeoutMS === 'number'
                ...
                : null);
            try {
                yield (0, execute_operation_1.executeOperation)(this.client, operation, timeoutContext);
                ...
                if (firstCommitError instanceof error_1.MongoError && (0, error_1.isRetryableWriteError)(firstCommitError)) {
                    ...
                    try {
                        yield (0, execute_operation_1.executeOperation)(this.client, new run_command_1.RunAdminCommandOperation(command, {
                            session: this,
                            readPreference: read_preference_1.ReadPreference.primary,
                            bypassPinningCheck: true
                        }), timeoutContext);
    ...
    abortTransaction(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const timeoutMS = typeof (options === null || options === void 0 ? void 0 : options.timeoutMS) === 'number'
                ? options.timeoutMS
                : ((_a = this.timeoutContext) === null || _a === void 0 ? void 0 : _a.csotEnabled())
            ...
            const timeoutContext = timeoutMS != null
                ...
                : null;
            const wc = (_b = this.transaction.options.writeConcern) !== null && _b !== void 0 ? _b : (_c = this.clientOptions) === null || _c === void 0 ? void 0 : _c.writeConcern;
            ...
            try {
                ...
                if ((options === null || options === void 0 ? void 0 : options.throwTimeout) && firstAbortError.name === 'MongoOperationTimeoutError') {
                    throw firstAbortError;
                }
                if (firstAbortError instanceof error_1.MongoError && (0, error_1.isRetryableWriteError)(firstAbortError)) {
                    try {
                        ...
                        if ((options === null || options === void 0 ? void 0 : options.throwTimeout) && secondAbortError.name === 'MongoOperationTimeoutError') {
                            throw secondAbortError;
                        }
    ...
    withTransaction(fn, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const timeoutMS = (_b = (_a = options === null || options === void 0 ? void 0 : options.timeoutMS) !== null && _a !== void 0 ? _a : this.timeoutMS) !== null && _b !== void 0 ? _b : null;
            this.timeoutContext =
                timeoutMS != null
                    ? timeout_1.TimeoutContext.create({
                        timeoutMS,
                    ...
                    : null;
            const startTime = ((_c = this.timeoutContext) === null || _c === void 0 ? void 0 : _c.csotEnabled()) ? this.timeoutContext.start : (0, utils_1.now)();
            let committed = false;
            let result;
            try {
                while (!committed) {
...
function isMaxTimeMSExpiredError(err) {
    ...
    return (err.code === error_1.MONGODB_ERROR_CODES.MaxTimeMSExpired ||
        ((_a = err.writeConcernError) === null || _a === void 0 ? void 0 : _a.code) === error_1.MONGODB_ERROR_CODES.MaxTimeMSExpired);
}
/**
...
class ServerSessionPool {
    ...
    acquire() {
        var _a, _b, _c;
        const sessionTimeoutMinutes = (_b = (_a = this.client.topology) === null || _a === void 0 ? void 0 : _a.logicalSessionTimeoutMinutes) !== null && _b !== void 0 ? _b : 10;
        let session = null;
        // Try to obtain from session pool
        while (this.sessions.length > 0) {
            const potentialSession = this.sessions.shift();
            if (potentialSession != null &&
                (!!((_c = this.client.topology) === null || _c === void 0 ? void 0 : _c.loadBalanced) ||
    ...
    release(session) {
        var _a, _b, _c;
        const sessionTimeoutMinutes = (_b = (_a = this.client.topology) === null || _a === void 0 ? void 0 : _a.logicalSessionTimeoutMinutes) !== null && _b !== void 0 ? _b : 10;
        if (((_c = this.client.topology) === null || _c === void 0 ? void 0 : _c.loadBalanced) && !sessionTimeoutMinutes) {
...
function applySession(session, command, options) {
    ...
    if (((_a = options.writeConcern) === null || _a === void 0 ? void 0 : _a.w) === 0) {
...
function updateSessionFromResponse(session, document) {
    ...
    if ((session === null || session === void 0 ? void 0 : session.snapshotEnabled) && session.snapshotTime == null) {

...
function retryDNSTimeoutFor(api) {
    return function dnsReqRetryTimeout(lookupAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield dns.promises[api](lookupAddress);
            }
            catch (firstDNSError) {
...
function resolveSRVRecord(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const addresses = yield resolveSrv(hostname);
        ...
        let record;
        try {
            record = yield txtResolutionPromise;
        }
        catch (error) {
...
function parseOptions(uri, mongoClient = undefined, options = {}) {
    ...
    for (const key of allProvidedKeys) {
        ...
        const urlValues = (_a = urlOptions.get(key)) !== null && _a !== void 0 ? _a : [];
...
exports.OPTIONS = {
        ...
        transform({ options, values }) {
            ...
            for (const optionValue of values) {
                if (typeof optionValue === 'string') {
                    ...
                    mechanismProperties = Object.assign({}, optionValue);
                }
            }
            return mongo_credentials_1.MongoCredentials.merge(options.credentials, {
                mechanismProperties
    ...
    readConcern: {
        transform({ values: [value], options }) {
            if (value instanceof read_concern_1.ReadConcern || (0, utils_1.isRecord)(value, ['level'])) {
                return read_concern_1.ReadConcern.fromOptions(Object.assign(Object.assign({}, options.readConcern), value));
            }
    ...
    readConcernLevel: {
        ...
        transform({ values: [level], options }) {
            return read_concern_1.ReadConcern.fromOptions(Object.assign(Object.assign({}, options.readConcern), { level: level }));
        }
    },
    readPreference: {
        ...
        transform({ values: [value], options }) {
            ...
            if (value instanceof read_preference_1.ReadPreference) {
                return read_preference_1.ReadPreference.fromOptions(Object.assign({ readPreference: Object.assign(Object.assign({}, options.readPreference), value) }, value));
            }
            if ((0, utils_1.isRecord)(value, ['mode'])) {
                const rp = read_preference_1.ReadPreference.fromOptions(Object.assign({ readPreference: Object.assign(Object.assign({}, options.readPreference), value) }, value));
                if (rp)
                    return rp;
                else
    ...
    w: {
        target: 'writeConcern',
        transform({ values: [value], options }) {
            return write_concern_1.WriteConcern.fromOptions({ writeConcern: Object.assign(Object.assign({}, options.writeConcern), { w: value }) });
        }
    },
    waitQueueTimeoutMS: {
        // TODO(NODE-6491): deprecated: 'Please use timeoutMS instead',
    ...
    wtimeout: {
        ...
        transform({ values: [value], options }) {
            const wc = write_concern_1.WriteConcern.fromOptions({
                writeConcern: Object.assign(Object.assign({}, options.writeConcern), { wtimeout: getUIntFromOptions('wtimeout', value) })
            });
            if (wc)
                return wc;
    ...
    wtimeoutMS: {
        ...
        transform({ values: [value], options }) {
            const wc = write_concern_1.WriteConcern.fromOptions({
                writeConcern: Object.assign(Object.assign({}, options.writeConcern), { wtimeoutMS: getUIntFromOptions('wtimeoutMS', value) })
            });
            if (wc)
                return wc;
            throw new error_1.MongoParseError(`Cannot make WriteConcern from wtimeout`);

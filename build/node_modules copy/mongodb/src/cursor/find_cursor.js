...
class FindCursor extends explain_1.ExplainableCursor {
    ...
    clone() {
        ...
        return new FindCursor(this.client, this.namespace, this.cursorFilter, Object.assign({}, clonedOptions));
    }
    map(transform) {
    ...
    _initialize(session) {
        return __awaiter(this, void 0, void 0, function* () {
            const options = Object.assign(Object.assign(Object.assign({}, this.findOptions), this.cursorOptions), { session, signal: this.signal });
            if (options.explain) {
                try {
            ...
            const response = yield (0, execute_operation_1.executeOperation)(this.client, findOperation, this.timeoutContext);
    ...
    count(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, execute_operation_1.executeOperation)(this.client, new count_1.CountOperation(this.namespace, this.cursorFilter, Object.assign(Object.assign(Object.assign({}, this.findOptions), this.cursorOptions), options)));
        });
    }
    explain(verbosity, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const { explain, timeout } = this.resolveExplainTimeoutOptions(verbosity, options);
            return (yield (0, execute_operation_1.executeOperation)(this.client, new find_1.FindOperation(this.namespace, this.cursorFilter, Object.assign(Object.assign(Object.assign(Object.assign({}, this.findOptions), this.cursorOptions), timeout), { explain: explain !== null && explain !== void 0 ? explain : true })))).shift(this.deserializationOptions);
        });
    }

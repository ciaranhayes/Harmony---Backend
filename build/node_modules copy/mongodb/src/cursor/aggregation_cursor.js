...
class AggregationCursor extends explain_1.ExplainableCursor {
    ...
    constructor(client, namespace, pipeline = [], options = {}) {
        ...
        if (this.cursorOptions.timeoutMS != null &&
            ...
            ((lastStage === null || lastStage === void 0 ? void 0 : lastStage.$merge) != null || (lastStage === null || lastStage === void 0 ? void 0 : lastStage.$out) != null))
    ...
    clone() {
        ...
        return new AggregationCursor(this.client, this.namespace, this.pipeline, Object.assign({}, clonedOptions));
    }
    map(transform) {
    ...
    _initialize(session) {
        return __awaiter(this, void 0, void 0, function* () {
            const options = Object.assign(Object.assign(Object.assign({}, this.aggregateOptions), this.cursorOptions), { session, signal: this.signal });
            if (options.explain) {
                try {
            ...
            const response = yield (0, execute_operation_1.executeOperation)(this.client, aggregateOperation, this.timeoutContext);
    ...
    explain(verbosity, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield (0, execute_operation_1.executeOperation)(this.client, new aggregate_1.AggregateOperation(this.namespace, this.pipeline, Object.assign(Object.assign(Object.assign(Object.assign({}, this.aggregateOptions), this.cursorOptions), timeout), { explain: explain !== null && explain !== void 0 ? explain : true })))).shift(this.deserializationOptions);
        });
    }
    addStage(stage) {

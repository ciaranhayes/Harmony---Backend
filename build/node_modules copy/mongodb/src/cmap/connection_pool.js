...
class ConnectionPool extends mongo_types_1.TypedEventEmitter {
    constructor(server, options) {
        ...
        this.mongoLogger = (_g = this.server.topology.client) === null || _g === void 0 ? void 0 : _g.mongoLogger;
    ...
    checkOut(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return yield (timeout ? Promise.race([promise, timeout]) : promise);
            }
            catch (error) {
    ...
    reauthenticate(connection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield provider.reauth(authContext);
            return;
        });
    }
    ...
    createConnection(callback) {
        const connectOptions = Object.assign(Object.assign({}, this.options), { id: this.connectionCounter.next().value, generation: this.generation, cancellationToken: this.cancellationToken, mongoLogger: this.mongoLogger, authProviders: this.server.topology.client.s.authProviders });
        this.pending++;

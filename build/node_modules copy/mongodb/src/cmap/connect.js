...
function connect(options) {
    return __awaiter(this, void 0, void 0, function* () {
        let connection = null;
        try {
            const socket = yield makeSocket(options);
            connection = makeConnection(options, socket);
            yield performInitialHandshake(connection, options);
            return connection;
        }
        catch (error) {
...
function performInitialHandshake(conn, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const handshakeDoc = yield prepareHandshakeDocument(authContext);
        // @ts-expect-error: TODO(NODE-5141): The options need to be filtered properly, Connection options differ from Command options
        const handshakeOptions = Object.assign(Object.assign({}, options), { raw: false });
        if (typeof options.connectTimeoutMS === 'number') {
            // The handshake technically is a monitoring check, so its socket timeout should be connectTimeoutMS
            handshakeOptions.socketTimeoutMS = options.connectTimeoutMS;
        }
        const start = new Date().getTime();
        const response = yield executeHandshake(handshakeDoc, handshakeOptions);
        ...
        function executeHandshake(handshakeDoc, handshakeOptions) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const handshakeResponse = yield conn.command((0, utils_1.ns)('admin.$cmd'), handshakeDoc, handshakeOptions);
...
function prepareHandshakeDocument(authContext) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const clientMetadata = yield options.extendedMetadata;
        const handshakeDoc = {
            [(serverApi === null || serverApi === void 0 ? void 0 : serverApi.version) || options.loadBalanced === true ? 'hello' : constants_1.LEGACY_HELLO_COMMAND]: 1,
            helloOk: true,
        ...
        if (credentials) {
            if (credentials.mechanism === providers_1.AuthMechanism.MONGODB_DEFAULT && credentials.username) {
                ...
                return yield provider.prepare(handshakeDoc, authContext);
            }
...
function makeSocket(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const noDelay = (_b = options.noDelay) !== null && _b !== void 0 ? _b : true;
        const connectTimeoutMS = (_c = options.connectTimeoutMS) !== null && _c !== void 0 ? _c : 30000;
        const existingSocket = options.existingSocket;
        let socket;
        if (options.proxyHost != null) {
            // Currently, only Socks5 is supported.
            return yield makeSocks5Connection(Object.assign(Object.assign({}, options), { connectTimeoutMS // Should always be present for Socks5
             }));
        }
        if (useTLS) {
...
function makeSocks5Connection(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const rawSocket = yield makeSocket(Object.assign(Object.assign({}, options), { hostAddress, tls: false, proxyHost: undefined }));
        ...
        try {
            ...
            const connection = yield socks.SocksClient.createConnection({
        ...
        return yield makeSocket(Object.assign(Object.assign({}, options), { existingSocket, proxyHost: undefined }));
    });
}

...
function extractCommand(command) {
    ...
    if (command instanceof commands_1.OpMsgRequest) {
        const cmd = Object.assign({}, command.command);
        ...
        if (command.ns === 'admin.$cmd') {
            ...
            Object.keys(LEGACY_FIND_QUERY_MAP).forEach(key => {
                if (command.query[key] != null) {
                    result[LEGACY_FIND_QUERY_MAP[key]] = Object.assign({}, command.query[key]);
                }
            });
        }
    ...
    let clonedQuery = {};
    const clonedCommand = Object.assign({}, command);
    if (command.query) {
        clonedQuery = Object.assign({}, command.query);

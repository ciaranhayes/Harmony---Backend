...
class MongoCredentials {
    constructor(options) {
        var _a;
        this.username = (_a = options.username) !== null && _a !== void 0 ? _a : '';
        ...
        if (this.mechanism.match(/MONGODB-AWS/i)) {
            ...
            if (this.mechanismProperties.AWS_SESSION_TOKEN == null &&
                ...
                this.mechanismProperties = Object.assign(Object.assign({}, this.mechanismProperties), { AWS_SESSION_TOKEN: process.env.AWS_SESSION_TOKEN });
            }
        }
        if (this.mechanism === providers_1.AuthMechanism.MONGODB_OIDC && !this.mechanismProperties.ALLOWED_HOSTS) {
            this.mechanismProperties = Object.assign(Object.assign({}, this.mechanismProperties), { ALLOWED_HOSTS: exports.DEFAULT_ALLOWED_HOSTS });
        }

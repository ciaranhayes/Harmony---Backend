...
class CallbackWorkflow {
     ...
     */
    startAuthentication(connection, credentials, response) {
        return __awaiter(this, void 0, void 0, function* () {
            let result;
            if (response === null || response === void 0 ? void 0 : response.speculativeAuthenticate) {
                ...
                result = yield connection.command((0, utils_1.ns)(credentials.source), (0, command_builders_1.startCommandDocument)(credentials), undefined);
            }
            return result;
        });
    }
     ...
     */
    finishAuthentication(connection, credentials, token, conversationId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield connection.command((0, utils_1.ns)(credentials.source), (0, command_builders_1.finishCommandDocument)(token, conversationId), undefined);
        });
    }
    /**
     * Executes the callback and validates the output.
     */
    executeAndValidateCallback(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.callback(params);
        ...
        return (params) => __awaiter(this, void 0, void 0, function* () {
            ...
            lock = lock
                ...
                if (difference <= THROTTLE_MS) {
                    yield (0, promises_1.setTimeout)(THROTTLE_MS - difference, { signal: params.timeoutContext });
                }

...
function onData(emitter, { timeoutContext, signal }) {
    ...
    const timeoutForSocketRead = timeoutContext === null || timeoutContext === void 0 ? void 0 : timeoutContext.timeoutForSocketRead;
    timeoutForSocketRead === null || timeoutForSocketRead === void 0 ? void 0 : timeoutForSocketRead.throwIfExpired();
    timeoutForSocketRead === null || timeoutForSocketRead === void 0 ? void 0 : timeoutForSocketRead.then(undefined, errorHandler);
    return iterator;
    ...
    function closeHandler() {
        ...
        finished = true;
        timeoutForSocketRead === null || timeoutForSocketRead === void 0 ? void 0 : timeoutForSocketRead.clear();

...
class MongoDBResponse extends document_1.OnDemandDocument {
    ...
    get isMaxTimeExpiredError() {
        ...
        const isWriteConcern = ((_a = this.get('writeConcernError', bson_1.BSONType.object)) === null || _a === void 0 ? void 0 : _a.getNumber('code')) ===
            error_1.MONGODB_ERROR_CODES.MaxTimeMSExpired;
        if (isWriteConcern)
            return true;
        const writeErrors = this.get('writeErrors', bson_1.BSONType.array);
        if (writeErrors === null || writeErrors === void 0 ? void 0 : writeErrors.size()) {
            for (let i = 0; i < writeErrors.size(); i++) {
                const isWriteError = ((_b = writeErrors.get(i, bson_1.BSONType.object)) === null || _b === void 0 ? void 0 : _b.getNumber('code')) ===
                    error_1.MONGODB_ERROR_CODES.MaxTimeMSExpired;
    ...
    get atClusterTime() {
        var _a, _b;
        return ((_b = (_a = this.get('cursor', bson_1.BSONType.object)) === null || _a === void 0 ? void 0 : _a.get('atClusterTime', bson_1.BSONType.timestamp)) !== null && _b !== void 0 ? _b : this.get('atClusterTime', bson_1.BSONType.timestamp));
    }
    get operationTime() {
    ...
    get $clusterTime() {
        ...
        if (!('clusterTime' in this)) {
            ...
            const signature = (_a = clusterTimeDoc.get('signature', bson_1.BSONType.object)) === null || _a === void 0 ? void 0 : _a.toObject();
            // @ts-expect-error: `signature` is incorrectly typed. It is public API.
            this.clusterTime = { clusterTime, signature };
        }
        return (_b = this.clusterTime) !== null && _b !== void 0 ? _b : null;
    }
    toObject(options) {
        const exactBSONOptions = Object.assign(Object.assign({}, (0, bson_1.pluckBSONSerializeOptions)(options !== null && options !== void 0 ? options : {})), { validation: (0, bson_1.parseUtf8ValidationOption)(options) });
...
class CursorResponse extends MongoDBResponse {
    ...
    get encryptedBatch() {
        ...
        const cursor = (_a = this.encryptedResponse) === null || _a === void 0 ? void 0 : _a.get('cursor', bson_1.BSONType.object);
    ...
    shift(options) {
        ...
        const result = (_a = this.batch.get(this.iterated, bson_1.BSONType.object, true)) !== null && _a !== void 0 ? _a : null;
        const encryptedResult = (_c = (_b = this.encryptedBatch) === null || _b === void 0 ? void 0 : _b.get(this.iterated, bson_1.BSONType.object, true)) !== null && _c !== void 0 ? _c : null;
        this.iterated += 1;

...
class OnDemandDocument {
    ...
    getNumber(name, required) {
        ...
        const result = (_b = (_a = bool !== null && bool !== void 0 ? bool : long) !== null && _a !== void 0 ? _a : this.get(name, bson_1.BSONType.int)) !== null && _b !== void 0 ? _b : this.get(name, bson_1.BSONType.double);
     ...
     */
    toObject(options) {
        return (0, bson_1.deserialize)(this.bson, Object.assign(Object.assign({}, options), { index: this.offset, allowObjectSmallerThanBufferSize: true }));
    }

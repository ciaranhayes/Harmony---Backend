...
function resolveTimeoutOptions(client, options) {
    ...
    return Object.assign({ socketTimeoutMS, serverSelectionTimeoutMS, waitQueueTimeoutMS, timeoutMS }, options);
}
/**
...
function resolveOptions(parent, options) {
    ...
    const timeoutMS = (_a = options === null || options === void 0 ? void 0 : options.timeoutMS) !== null && _a !== void 0 ? _a : parent === null || parent === void 0 ? void 0 : parent.timeoutMS;
    // Users cannot pass a readConcern/writeConcern to operations in a transaction
    const session = options === null || options === void 0 ? void 0 : options.session;
    if (!(session === null || session === void 0 ? void 0 : session.inTransaction())) {
        const readConcern = (_b = read_concern_1.ReadConcern.fromOptions(options)) !== null && _b !== void 0 ? _b : parent === null || parent === void 0 ? void 0 : parent.readConcern;
        if (readConcern) {
            result.readConcern = readConcern;
        }
        let writeConcern = (_c = write_concern_1.WriteConcern.fromOptions(options)) !== null && _c !== void 0 ? _c : parent === null || parent === void 0 ? void 0 : parent.writeConcern;
        if (writeConcern) {
            if (timeoutMS != null) {
                writeConcern = write_concern_1.WriteConcern.fromOptions({
                    writeConcern: Object.assign(Object.assign({}, writeConcern), { wtimeout: undefined, wtimeoutMS: undefined })
                });
            }
    ...
    const readPreference = (_d = read_preference_1.ReadPreference.fromOptions(options)) !== null && _d !== void 0 ? _d : parent === null || parent === void 0 ? void 0 : parent.readPreference;
    if (readPreference) {
...
class HostAddress {
    ...
    toHostPort() {
        ...
        const port = (_b = this.port) !== null && _b !== void 0 ? _b : 0;
        return { host, port };
    }
}
...
function request(uri_1) {
    return __awaiter(this, arguments, void 0, function* (uri, options = {}) {
        return yield new Promise((resolve, reject) => {
            const requestOptions = Object.assign(Object.assign({ method: 'GET', timeout: 10000, json: true }, url.parse(uri)), options);
...
function once(ee, name, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            abortListener === null || abortListener === void 0 ? void 0 : abortListener[exports.kDispose]();
        }
    });
}
...
function fileIsAccessible(fileName, mode) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield fs_1.promises.access(fileName, mode);
            return true;
        }
        catch (_a) {
            return false;
...
/** @internal */
exports.kDispose = (_a = Symbol.dispose) !== null && _a !== void 0 ? _a : Symbol('dispose');
/**
 ...
 */
function abortable(promise_1, _a) {
    return __awaiter(this, arguments, void 0, function* (promise, { signal }) {
        if (signal == null) {
            return yield promise;
        }
        ...
        try {
            return yield Promise.race([promise, aborted]);
        }
        finally {
            abortListener === null || abortListener === void 0 ? void 0 : abortListener[exports.kDispose]();
        }

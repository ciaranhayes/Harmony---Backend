...
function executeCommands(bulkOperation, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const batch of bulkOperation.s.batches) {
            const finalOptions = (0, utils_1.resolveOptions)(bulkOperation, Object.assign(Object.assign({}, options), { ordered: bulkOperation.isOrdered }));
            ...
            let result;
            try {
                result = yield (0, execute_operation_1.executeOperation)(bulkOperation.s.collection.client, operation, finalOptions.timeoutContext);
            }
            catch (error) {
                thrownError = error;
            }
...
class FindOperators {
    ...
    update(updateDocument) {
        ...
        return this.bulkOperation.addToOperationsList(exports.BatchType.UPDATE, (0, update_1.makeUpdateStatement)(currentOp.selector, updateDocument, Object.assign(Object.assign({}, currentOp), { multi: true })));
    }
    ...
    updateOne(updateDocument) {
        ...
        const currentOp = buildCurrentOp(this.bulkOperation);
        return this.bulkOperation.addToOperationsList(exports.BatchType.UPDATE, (0, update_1.makeUpdateStatement)(currentOp.selector, updateDocument, Object.assign(Object.assign({}, currentOp), { multi: false })));
    }
    ...
    replaceOne(replacement) {
        ...
        const currentOp = buildCurrentOp(this.bulkOperation);
        return this.bulkOperation.addToOperationsList(exports.BatchType.UPDATE, (0, update_1.makeUpdateStatement)(currentOp.selector, replacement, Object.assign(Object.assign({}, currentOp), { multi: false })));
    }
    /** Add a delete one operation to the bulk operation */
    deleteOne() {
        const currentOp = buildCurrentOp(this.bulkOperation);
        return this.bulkOperation.addToOperationsList(exports.BatchType.DELETE, (0, delete_1.makeDeleteStatement)(currentOp.selector, Object.assign(Object.assign({}, currentOp), { limit: 1 })));
    }
    /** Add a delete many operation to the bulk operation */
    delete() {
        const currentOp = buildCurrentOp(this.bulkOperation);
        return this.bulkOperation.addToOperationsList(exports.BatchType.DELETE, (0, delete_1.makeDeleteStatement)(currentOp.selector, Object.assign(Object.assign({}, currentOp), { limit: 0 })));
    }
...
class BulkWriteShimOperation extends operation_1.AbstractOperation {
    ...
    execute(_server, session, timeoutContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield executeCommands(this.bulkOperation, Object.assign(Object.assign({}, this.options), { timeoutContext }));
        });
    }
}
...
class BulkOperationBase {
    ...
    raw(op) {
        ...
        if ('replaceOne' in op || 'updateOne' in op || 'updateMany' in op) {
            if ('replaceOne' in op) {
                ...
                const updateStatement = (0, update_1.makeUpdateStatement)(op.replaceOne.filter, op.replaceOne.replacement, Object.assign(Object.assign({}, op.replaceOne), { multi: false }));
            ...
            if ('updateOne' in op) {
                ...
                const updateStatement = (0, update_1.makeUpdateStatement)(op.updateOne.filter, op.updateOne.update, Object.assign(Object.assign({}, op.updateOne), { multi: false }));
                if (!(0, utils_1.hasAtomicOperators)(updateStatement.u)) {
                    throw new error_1.MongoInvalidArgumentError('Update document requires atomic operators');
                }
                return this.addToOperationsList(exports.BatchType.UPDATE, updateStatement);
            ...
            if ('updateMany' in op) {
                ...
                const updateStatement = (0, update_1.makeUpdateStatement)(op.updateMany.filter, op.updateMany.update, Object.assign(Object.assign({}, op.updateMany), { multi: true }));
                if (!(0, utils_1.hasAtomicOperators)(updateStatement.u)) {
                    throw new error_1.MongoInvalidArgumentError('Update document requires atomic operators');
                }
                return this.addToOperationsList(exports.BatchType.UPDATE, updateStatement);
        ...
        if ('deleteOne' in op) {
            ...
            return this.addToOperationsList(exports.BatchType.DELETE, (0, delete_1.makeDeleteStatement)(op.deleteOne.filter, Object.assign(Object.assign({}, op.deleteOne), { limit: 1 })));
        }
        if ('deleteMany' in op) {
            if ('q' in op.deleteMany) {
                throw new error_1.MongoInvalidArgumentError('Raw operations are not allowed');
            }
            return this.addToOperationsList(exports.BatchType.DELETE, (0, delete_1.makeDeleteStatement)(op.deleteMany.filter, Object.assign(Object.assign({}, op.deleteMany), { limit: 0 })));
        }
    ...
    execute() {
        return __awaiter(this, arguments, void 0, function* (options = {}) {
            ...
            const finalOptions = Object.assign(Object.assign({}, this.s.options), options);
            const operation = new BulkWriteShimOperation(this, finalOptions);
            return yield (0, execute_operation_1.executeOperation)(this.s.collection.client, operation, finalOptions.timeoutContext);
        });
    }
    /**
